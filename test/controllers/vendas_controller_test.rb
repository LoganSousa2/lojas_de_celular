...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post vendas_url, params: { venda: { cliente_id: @venda.cliente_id, data_venda: @venda.data_venda, produto_id: @venda.produto_id, total_vendido: @venda.total_vendido, valor: @venda.valor } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { cliente_id: @venda.cliente_id, data_venda: @venda.data_venda, produto_id: @venda.produto_id, total_vendido: @venda.total_vendido, valor: @venda.valor } }
