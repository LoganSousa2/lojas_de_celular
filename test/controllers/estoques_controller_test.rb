...
class EstoquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estoque" do
    assert_difference('Estoque.count') do
      post estoques_url, params: { estoque: { ano: @estoque.ano, marcas: @estoque.marcas, quantidade: @estoque.quantidade, tipo: @estoque.tipo } }
    end
  ...
  test "should update estoque" do
    patch estoque_url(@estoque), params: { estoque: { ano: @estoque.ano, marcas: @estoque.marcas, quantidade: @estoque.quantidade, tipo: @estoque.tipo } }
