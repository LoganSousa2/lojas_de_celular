...
class FornecedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post fornecedors_url, params: { fornecedor: { cidade: @fornecedor.cidade, cpf_cnpj: @fornecedor.cpf_cnpj, email: @fornecedor.email, endereco: @fornecedor.endereco, estado: @fornecedor.estado, nome: @fornecedor.nome, telefone: @fornecedor.telefone } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { cidade: @fornecedor.cidade, cpf_cnpj: @fornecedor.cpf_cnpj, email: @fornecedor.email, endereco: @fornecedor.endereco, estado: @fornecedor.estado, nome: @fornecedor.nome, telefone: @fornecedor.telefone } }
