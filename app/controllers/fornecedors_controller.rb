class FornecedorsController < ApplicationController
  ...
  def relatorio
    @fornecedors = Produto.all
    respond_to do |format|
      format.pdf do
          pdf = RelatorioPdf.new(@fornecedors, @view_context) 
  ...
  private
    ...
    def fornecedor_params
      params.require(:fornecedor).permit(:nome, :cpf_cnpj, :email, :telefone, :endereco, :cidade, :estado)
    end
end
